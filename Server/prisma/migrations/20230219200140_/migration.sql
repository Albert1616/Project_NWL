...
CREATE TABLE "new_Day_habit" (
    ...
    CONSTRAINT "Day_habit_id_day_fkey" FOREIGN KEY ("id_day") REFERENCES "days" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Day_habit_id_habit_fkey" FOREIGN KEY ("id_habit") REFERENCES "habits" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_habit_week_days" (
    ...
    CONSTRAINT "habit_week_days_id_habit_fkey" FOREIGN KEY ("id_habit") REFERENCES "habits" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
